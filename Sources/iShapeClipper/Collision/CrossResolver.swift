...
enum CrossType: Int {
    ...
    case pure           =  1    // simple intersection with no overlaps or common points
    case end_a0         =  4
    case end_a1         =  5
    case end_b0         =  6
    case end_b1         =  7
...
struct CrossResolver {
    ...
    static func isCross(a0: IntPoint, a1: IntPoint, b0: IntPoint, b1: IntPoint, cross: inout IntPoint) -> CrossType {
        guard Rect(a: a0, b: a1).isIntersecting(rect: Rect(a: b0, b: b1)) else {
            return .not_cross
        }
