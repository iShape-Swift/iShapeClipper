...
//        while i >= 0 {
//            let shape = self[i]
//            let solution = shape.complexUnion(path: unionPath)
...
//                self.remove(at: i)
//            case .overlap:
//                unionPath = solution.pathList.get(index: 0)
...
//        }
//
//        var unionShape = PlainShape(points: unionPath)
//        // TODO optimise
//        if !holes.layouts.isEmpty {
//            for j in 1..<holes.layouts.count {
